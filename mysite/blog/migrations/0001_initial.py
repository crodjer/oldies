...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('blog_post', (
            ...
            ('is_update', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('added_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('blog', ['Post'])

        # Adding M2M table for field subscribers on 'Post'
        db.create_table('blog_post_subscribers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('post', models.ForeignKey(orm['blog.post'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('blog_post_subscribers', ['post_id', 'user_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field subscribers on 'Post'
        db.delete_table('blog_post_subscribers')
